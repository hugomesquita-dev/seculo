...
const detailsComunication = ({route, navigation}) => {
    ...
    //     }
    // }
    const autoExecLido = async () => {
        // console.log(`idnotificação: ${id_notificacao}`);
        // console.log(`usuário: ${user.USU_LOGIN}`);

        api 
        .post('notificacao/readNotificacao/', {
            p_id_notificacao: id_notificacao,
            p_cd_usuario: user.USU_LOGIN
        }).then((res) => {
            console.log(res.data[0].mensagem);
        })
    }
    ...
    const sharedImage = async () =>{
        ...
        //encodeImageFileAsURL(`https://seculomanaus.com.br/componentes/portal/arquivos/${anexo}`);
        // const shareOptions = {
        //     title: 'Titulo',
        //     failOnCancel: false,
        // };
                ...
                <View>
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={{flex:1, flexDirection: 'column'}}>
                            ...
                            <View style={{flex:1}}>
                                    <View style={{backgroundColor:"#FFFFFF", width:'100%', height:'100%', position: 'absolute', bottom: 0}}>
                                    
                                    
                                    <TouchableOpacity style={{justifyContent:'center', alignItems: 'center', marginTop:60,  zIndex:9999}} onPress={() => closeModal()}>
                                        <Text style={{fontSize: responsiveFontSize(2), fontWeight: 'bold', alignSelf: "flex-end", right: 20}}><Icon name="close" size={25}/></Text>
                                    </TouchableOpacity>
